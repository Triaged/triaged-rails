...
Provider.create(name: "stripe", webhooks_enabled: false, title: "Stripe", short_title: "Stripe", oauth: true, active: true) # This is odd, because stripe does use a webhook, but because of setup, we turn off.
Provider.create(name: "github", webhooks_enabled: true, title: "GitHub", short_title: "GitHub", account_label: 'Organization', property_label: 'Repo', oauth: true, active: true)
...
Provider.create(name: "google_analytics", webhooks_enabled: false, title: "Google Analytics", short_title: "Google", account_label: 'Account', property_label: 'Property', oauth: true, active: true)
...
Provider.create(name: "dropbox", webhooks_enabled: false, title: "Dropbox", short_title: "Dropbox", oauth: true, active: true)
Provider.create(name: "trello", webhooks_enabled: false, title: "Trello", short_title: "Trello", oauth: true, active: true)
Provider.create(name: "appfigures", webhooks_enabled: false, title: "appFigures", short_title: "appFigures", account_label: 'Account', property_label: 'App', oauth: true, active: true)
